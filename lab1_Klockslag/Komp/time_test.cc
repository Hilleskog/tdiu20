...
//TODO Ni bör testa att lägga till/ta bort en timme, en dag, flera dagar.
...
TEST_CASE (" == ")
{
     //Comment kan skrivas som CHECK((Time{00,00,23} == Time{00,00,23}));
  CHECK ((Time{00,00,23} == Time{00,00,23}));

  //Comment kan skrivas som CHECK_FALSE(Time{12,42,11} == Time{23,21,43});
  CHECK_FALSE ((Time{12,42,11} == Time{23,21,43}));
}
